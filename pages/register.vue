...
export default {
  ...
  methods:{
    ...
    register(){
        this.$store.dispatch('register', {email: this.form.mail.val,password: this.form.password.val,name: this.form.name.val,}
        )
      },
...
　　　
      onSubmit() {
          ...
          if(!this.form.mail.errorMessage && !this.form.password.errorMessage && !this.form.name.errorMessage){
